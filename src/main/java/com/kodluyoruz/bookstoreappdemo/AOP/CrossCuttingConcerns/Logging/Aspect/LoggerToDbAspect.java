package com.kodluyoruz.bookstoreappdemo.AOP.CrossCuttingConcerns.Logging.Aspect;

import com.kodluyoruz.bookstoreappdemo.AOP.CrossCuttingConcerns.Logging.LogParameters;
import com.kodluyoruz.bookstoreappdemo.AOP.CrossCuttingConcerns.Logging.LogRepository;
import com.kodluyoruz.bookstoreappdemo.AOP.CrossCuttingConcerns.Logging.LogStatus;
...
public class LoggerToDbAspect {
    ...
    @Pointcut("@annotation(com.kodluyoruz.bookstoreappdemo.AOP.Annotations.Logging.LoggerToDbForResult)")
    public void callToMethod(){
    }

    @AfterReturning(value = "callToMethod()",returning = "result")

    // bookaddedDto{name :"book",categoryId ....},
    // Refflection
